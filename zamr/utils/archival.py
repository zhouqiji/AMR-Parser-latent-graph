...
from zamr.models.model import Model, _DEFAULT_WEIGHTS

logger = logging.getLogger(__name__)  # pylint: disable=invalid-name

# An archive comprises a Model and its experimental config
Archive = NamedTuple("Archive", [("model", Model), ("config", Config)])
...
def load_archive(archive_file: str,
    ...
    # Load config
    config = Config.from_file(os.path.join(serialization_dir, CONFIG_NAME))
