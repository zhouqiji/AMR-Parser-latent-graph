...
from zamr.utils.file import get_file_extension, cached_path
from zamr.data_utils import Vocabulary
from zamr.modules.token_embedders.token_embedder import TokenEmbedder
from zamr.modules.time_distributed import TimeDistributed
import re
...
class Embedding(TokenEmbedder):
    ...
    :class:`~zamr.data_utils.fields.TextField`, you should use a
    :class:`~zarm.modules.TextFieldEmbedder` instead of using this directly.
    ...
    def __init__(self,
        ...
        if weight is None:
            weight = torch.empty(size=(num_embeddings, embedding_dim), dtype=torch.float32)
