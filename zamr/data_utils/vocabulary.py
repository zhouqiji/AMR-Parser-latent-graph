...
from typing import Any, Callable, Dict, Iterable, List, Optional, Sequence, Union, Set

from zamr.utils.string import namespace_match
from zamr.utils.configs import Config
from zamr.utils.checks import ConfigurationError
from zamr.utils.tqdm import Tqdm
from zamr.data_utils import instance as adi  # pylint: disable=unused-import

logger = logging.getLogger(__name__)  # pylint: disable=unused-import
...
def _read_pretrained_tokens(embeddings_file_uri: str) -> List[str]:
    ...
    from zamr.modules.token_embedders import EmbeddingsTextFile
...
def pop_max_vocab_size(params: Config) -> Union[int, Dict[str, int]]:
    """
...
class Vocabulary:
 ...
 line, with nothing else in the line.  The index we assign to the token is the line
    ...
    @classmethod
    def from_params(cls, params: Config, instances: Iterable['adi.Instance'] = None):  # type: ignore
        """
