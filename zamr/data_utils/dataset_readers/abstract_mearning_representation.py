...
from zamr.utils.file import cached_path
from zamr.data_utils.dataset_readers.dataset_reader import DatasetReader
from zamr.data_utils.fields import TextField, SpanField, SequenceLabelField, ListField, MetadataField, Field, \
    AdjacencyField, \
    ArrayField
from zamr.data_utils.instance import Instance
from zamr.data_utils.token_indexers import TokenIndexer, SingleIdTokenIndexer
from zamr.data_utils.tokenizers import Token
from zamr.data_utils.tokenizers.bert_tokenizer import AMRBertTokenizer
from zamr.utils.checks import ConfigurationError
from zamr.utils.string import START_SYMBOL, END_SYMBOL
...
class AbstractMeaningRepresentationDatasetReader(DatasetReader):
    ...
    def text_to_instance(self, amr):
        ...
        dep_heads = list_data['dep_heads']
        fields['dep_heads'] = SequenceLabelField(
            labels=dep_heads,
            sequence_field=fields['src_tokens'],
