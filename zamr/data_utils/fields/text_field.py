...
from zamr.data_utils.fields.sequence_field import SequenceField
from zamr.data_utils.tokenizers.token import Token
from zamr.data_utils.token_indexers.token_indexer import TokenIndexer, TokenType
from zamr.data_utils.vocabulary import Vocabulary
from zamr.utils.nn import batch_tensor_dicts
...
class TextField(SequenceField[Dict[str, torch.Tensor]]):
    ...
    to tokenize raw strings using a :class:`~zamr.data_utils.tokenizers.tokenizer.Tokenizer`.
    Because string tokens can be represented as indexed arrays in a number of ways, we also take a
    dictionary of :class:`~zamr.data_utils.token_indexers.token_indexer.TokenIndexer`
