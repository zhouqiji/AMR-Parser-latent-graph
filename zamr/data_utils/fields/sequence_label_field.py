...
from zamr.utils.string import pad_sequence_to_length
from zamr.data_utils.fields.field import Field
...
class SequenceLabelField(Field[torch.Tensor]):
    ...
    :class:`~zamr.data_utils.fields.sequence_field.SequenceField`.
